...
/**
 * add support on SEMICOLON and COMMENT
 * 
...
public class Miscellany {
	...
	static void getCharX() throws IOException {
	...
	static void skipComment() throws IOException {
	...
	static void semi() throws IOException {
		if (token == ';') {
			next();
		}
	}
